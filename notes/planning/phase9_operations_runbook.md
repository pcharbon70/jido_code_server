...
- `tool.failed`:
  ...
  - if reason contains `workspace_command_failed`, inspect the configured `command_executor` and command prompt compatibility with workspace-shell command semantics.
- `tool.cancelled`:
